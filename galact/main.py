...
class Galact():
    def __init__(self):
        ...
        console.print(
            '[underline]A bot[/] made by [green]Abso[/][blue]zero[/], using re.')
        console.print('Make sure to have fun!', style="bold underline blue")
        console.print(
            'enter [underline][bold red]\'quit\' or \'exit\'[/underline], [/bold red] to exit the program')
        print(os.getcwd())
        self.run()
    ...
    def run(self):
        while True:
            ...
            texts = console.input(
                '[italic blue_violet on bright_white]Send message:[/] ')
            ...
            if texts == "code":
                ...
                for n in track(range(n), description="[bold light_pink3]Scraping the web for the repository..."):
                    time.sleep(0.01)
                console.print(
                    "[bold italic link=https://github.com/absozero/Galact]https://github.com/absozero/galact[/]")
                console.print(
                    "[chartreuse3]Do not use this text or the emoji as the link :man_technologist_medium_skin_tone:")
                ...
                try:
                    ...
                    sys.exit(console.print(
                        '[bold red]Exited Galact with the appropriate phrase'))
                ...
                for n in track(range(n), description="[bold light_goldenrod2]Searching database for viable replies..."):
                    time.sleep(0.01)
                console.print(
                    '[bold medium_spring_green on dark_blue]Galact says:', self.match(texts))
...
parser_read = subparsers.add_parser(
    'readme', help='Show the readme of galact.')
